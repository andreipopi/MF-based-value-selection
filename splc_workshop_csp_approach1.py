...
def solve(prob,valueOrder,productConfigurations):
    ...
    for i in range(0,numberOfVariables):
        ...
        #add to the problem each variable with only one value, 
        #the one that should be selected which is encoded by a 1, SO:
        #if [1,0] then 0 should be selected, otherwise
        #   [0,1] then 1 should be selected
        #in this way, only the solution consisting of the desired assignment is possible
    ...
    print("value order:" + str(valueOrder))
